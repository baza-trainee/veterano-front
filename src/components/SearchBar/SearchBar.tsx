...
const SearchBar: FC<SearchBarProps> = ({style, value, onChange, placeholder, error, disabled = 'false', ...props}) => {
  ...
  return (
    <div tabIndex={props.tabIndex}
         ...
         className={disabled ? 'search-wrapper-disabled' : errors ? 'search-wrapper-error' :  "search-wrapper"} style={style}
    >
      <input
