...
const CookiesPanel = () => {
	...
	return (
		showPanel && (
			<div
				id="cookie-panel"
				className="fixed bottom-0 left-0 right-0 bg-[#F9F6EC] py-8 px-4 flex flex-col justify-center gap-6 md:h-[166px] md:px-6 md:py-6 lg:px-[80px] lg:h-[104px] lg:py-4 md:flex-row md:justify-between lg:min-w-[1440px] md:items-center  ">
