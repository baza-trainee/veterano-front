		...
		showPanel && (
			<div
				...
				className="fixed bottom-0 left-0 right-0 bg-[#F9F6EC] py-8 px-4 flex flex-col justify-center gap-6 md:px-6 md:py-6 md:h-[295px] lg:px-[80px] lg:h-[104px] lg:py-4 md:gap-9 lg:flex-row lg:justify-between lg:min-w-[1440px] lg:items-center  ">
					...
					<p className="text-[16px] leading-6 font-light lg:order-1 lg:min-w-[845px]">
				...
				<div className="w-full flex justify-center md:w-[95px] lg:order-2">
					<Button id="accept-cookies" variant={'primary'} size={'large'} onClick={acceptCookies} className={'py-[10px] h-[48px] text-[18px] leading-[28px] lg:w-[93px]'}>OK</Button>
				</div>
			</div>
		)
	);
